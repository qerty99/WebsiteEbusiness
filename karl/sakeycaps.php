      ...
      <header class="header_area bg-img background-overlay-white" style="background-image: url();">
                  ...
                  <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                      <li class="active" data-target="#product_details_slider" data-slide-to="0"
                        ...
                        style="background-image: url(img/product-img/keycaps/sa-blue.png);">
                        <br>
                      </li>
                      <li data-target="#product_details_slider" data-slide-to="1"

                        style="background-image: url(img/product-img/keycaps/sa-white.png);">
                        <br>
                      </li>
                      <li data-target="#product_details_slider" data-slide-to="2"

                        style="background-image: url(img/product-img/keycaps/sa-black.png);">
                        <br>
                      </li>
                      <li data-target="#product_details_slider" data-slide-to="3"

                        style="background-image: url(img/product-img/keycaps/sa-pink.png);">
                        <br>
                      </li>
                    </ol>
                      ...
                      <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" role="tabpanel"
                          ...
                          <div class="card-body">
                            ...
                            <p>Available in Blue, White, Black &amp; Pink</p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="modal fade" id="quickview" tabindex="-1" role="dialog" aria-labelledby="quickview"
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content"> <button type="button" class="close btn"
            ...
            <div class="row">
              <div class="col-12">
                <div class="you_make_like_slider owl-carousel">
                  ...
                  <div class="single_gallery_item">
                    <!-- Product Image -->
                    <div class="product-img"> <img src="img/product-img/keycaps/ch-green.png"
