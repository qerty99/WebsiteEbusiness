        ...
        <div class="row">
          <div class="col-12">
            <ol class="breadcrumb d-flex align-items-center">
              ...
              <li class="breadcrumb-item active">60% HS PCB</li>
            </ol>
        ...
        <div class="row">
              ...
              <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
                  <li class="active" data-target="#product_details_slider" data-slide-to="0"
                    ...
                    style="background-image: url(img/pcb-img/60HS.jpg);"> <br>
                  </li>
                  <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(img/pcb-img/60HS.jpg);">
                    <br>
                  </li>
                  <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(img/pcb-img/60HS.jpg);">
                    <br>
                  </li>
                  <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(img/pcb-img/60HS.jpg);">
                    <br>
                  </li>
                </ol>
                <div class="carousel-inner">
                  <div class="carousel-item active"> <a class="gallery_img" href="img/pcb-img/60HS.jpg">
                      <img class="d-block w-100" src="img/pcb-img/60HS.jpg" alt="First slide">
                    </a> </div>
                  <div class="carousel-item"> <a class="gallery_img" href="img/pcb-img/60HS.jpg">
                      <img class="d-block w-100" src="img/pcb-img/60pcb.png" alt="Second slide">
                    </a> </div>
                  <div class="carousel-item"> <a class="gallery_img" href="img/pcb-img/60HS.jpg">
                      <img class="d-block w-100" src="img/pcb-img/60pcb.png" alt="Third slide">
                    </a> </div>
                  <div class="carousel-item"> <a class="gallery_img" href="img/pcb-img/60HS.jpg">
                      <img class="d-block w-100" src="img/pcb-img/60pcb.png" alt="Fourth slide">
                    </a> </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-12 col-md-6">
            <div class="single_product_desc">
              <h4 class="title"><a href="img/pcb-img/60HS.jpg">60% PCB Hot-Swap</a></h4>
              <h4 class="price">$65.99</h4>
              ...
              <div id="accordion" role="tablist">
                <div class="card">
                  ...
                  <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne"
                    ...
                    <div class="card-body">
                      <p>60% Mechanical Hot Swapable PCB</p>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12 col-lg-5">
                    <div class="quickview_pro_img"> <img src="img/pcb-img/60pcb.png"

                        alt=""> </div>
                  </div>
                  <div class="col-12 col-lg-7">
                    <div class="quickview_pro_des">
                      <h4 class="title">60% PCB</h4>
                      ...
                      <h5 class="price">$59.99 <span>$59.99</span></h5>
                    ...
                    <form class="cart" method="post">
                      <div class="quantity"> <span class="qty-minus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty > 1 ) effect.value--;return false;"><i
                          ...
                          class="qty-text" id="qty2" step="1" min="1" max="12" name="quantity"
                      ...
                      <!-- Compare -->
                      <div class="modal_pro_compare"> <a href="compare.html" target="_blank"><i

                            class="ti-stats-up"></i></a> </div>
                    </form>
