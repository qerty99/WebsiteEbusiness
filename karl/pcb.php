                ...
                <div class="nav-side-menu">
                  ...
                  <div class="menu-list">
                    <ul id="menu-content2" class="menu-content collapse out">
                      <!-- Single Item -->
                      <li data-toggle="collapse" data-target="#women2"> <a href="#">PCB</a>
                        <ul class="sub-menu collapse show" id="women2">
                          <li><a href="#">Standard</a></li>
                          <li><a href="#">Hot-Swap</a></li>
                        </ul>
                      </li>
                    </ul>
                  </div>
            ...
            <div class="shop_grid_product_area">
              <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig"
                  ...
                  data-wow-delay="0.2s">
                  <!-- Product Image -->
                  <div class="product-img"> <img src="img/pcb-img/60pcb.png" alt=""

                      style="width: 304px; height: 172px;">
                    <div class="product-quicview" style="top: 0px; left: 0px; width: 274px; height: 171px;">
                ...
                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig"
                  ...
                  data-wow-delay="0.3s">
                  <!-- Product Image -->
                  <div class="product-img"> <img src="img/pcb-img/80pcb.png" alt=""
                ...
                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig"
                  ...
                  data-wow-delay="0.4s">
                  <!-- Product Image -->
                  <div class="product-img"> <img src="img/pcb-img/100pcb.jpg" alt=""
                ...
                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig"
                  ...
                  data-wow-delay="0.5s">
                  <!-- Product Image -->
                  <div class="product-img"> <img src="img/pcb-img/60HS.jpg" alt=""

                      style="width: 266px; height: 180px;">
                    <div class="product-quicview" style="top: 0px; height: 178px; left: 0px; width: 272px;">
                      <a href="#" data-toggle="modal" data-target="#quickview"><i
                ...
                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig"
                  ...
                  data-wow-delay="0.5s">
                  <!-- Product Image -->
                  <div class="product-img"> <img src="img/pcb-img/80HS.jpg" alt=""

                      style="width: 183px; height: 183px;">
                    <div class="product-quicview" style="top: 0px; left: 0px; width: 195px; height: 183px;">
                      <a href="#" data-toggle="modal" data-target="#quickview"><i
                ...
                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig"
                  ...
                  data-wow-delay="0.5s">
                  <!-- Product Image -->
                  <div class="product-img"> <img src="img/pcb-img/100HS.jpg" alt=""

                      style="width: 190px; height: 190px;">
                    <div class="product-quicview" style="top: 0px; left: 0px; width: 197px; height: 188px;">
                      <a href="#" data-toggle="modal" data-target="#quickview"><i
