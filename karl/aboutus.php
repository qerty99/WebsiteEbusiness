    ...
    <div id="wrapper">
      ...
      <section class="custom-keyboard">
        ...
        <div class="custom-desc">
          <p>Just like most great things, Suited Switch started off as a hobby
            in a garage of our parents house.</p>
          <p>Starting off making keyboards for friends and families, after a
            decade in the business we feel that we have honed the keyboard
            building process.</p>
          <p>After spending spending copious hours on the internet trying to
            source parts for builds we have managed to make a one stop shop for
            all your keyborads</p>
          <p>New to the DIY market? That's okay, as strong beleivers in self
            expression we aim to give you the best curated experience through
            our unique build service. </p>
        </div>
      </section>
      <!-- ****** Footer Area Start ****** -->
