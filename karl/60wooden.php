...
<head>
    ...
    <!-- Title  -->
    <title>The Suited Switch | 60% Wooden Case</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <ol class="breadcrumb d-flex align-items-center">
                            ...
                            <li class="breadcrumb-item active">60% Wooden Case</li>
                        </ol>
                        <!-- btn -->
                ...
                <div class="row">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(img/product-img/cases/60/rosewood.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(img/product-img/cases/60/walnut.jpg);">
                                    </li>
                                </ol>

                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="img/product-img/cases/60/rosewood.jpg">
                                        <img class="d-block w-100" src="img/product-img/cases/60/rosewood.jpg" alt="First slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/cases/60/walnut.jpg">
                                        <img class="d-block w-100" src="img/product-img/cases/60/walnut.jpg" alt="Second slide">
                                    </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            ...
                            <h4 class="title"><a href="#">60% Wooden Case</a></h4>
